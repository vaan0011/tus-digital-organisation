...
Der operative Status der Produkte liegt im Google Sheet **TuS Merch Production Master**.

Die Produktionsablage liegt im Google-Drive-Bereich **00_Merch_Production_Master**. Dort befinden sich Arbeitsstände, Product Sheets, Referenzmockups, Artwork Working, technische Spezifikationen, Proofs, Samples, Final Production Files und Webshop Assets.
...
### 3. Aktuelle Launch-Linie

Der Merch Production Master führt aktuell insbesondere folgende Launch-Produkte:

- `HER-001` Heritage Classic T-Shirt – Bordeaux
- `HER-002` Heritage Classic T-Shirt – Vintage Beige
- `HER-003` Heritage Hoodie – Anthrazit
- `GYM-001` Timeline Performance Shirt – Grau
- `GYM-002` Mengelse Athletic Heavy Shirt – Blackout
- `ACC-001` Blackout Snapback
- `CAP-125-001` 125 Jahre Heritage Shirt

Der aktuelle technische Status und alle offenen Produktionsangaben werden ausschließlich im Merch Production Master gepflegt.
...
### 6. Verbindliche Anti-Loop-Regeln
...
### 9. Ausstatter und externe Produktion

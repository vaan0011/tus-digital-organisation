...
| Include Fussball.de Widgets | 4.0.0 | fussball.de Widgets | `ERSETZEN / NICHT WEITERVERWENDEN` | Homepage-Zielbild ist kontrollierte Spiel-Datenintegration mit eigenem TuS-Rendering. Das offizielle WordPress-Plugin-Verzeichnis führt das Plugin seit 07.11.2025 wegen eines Sicherheitsproblems als geschlossen; es ist keine Zielbasis. Übergang erst nach funktionierender MatchCard-Integration. |

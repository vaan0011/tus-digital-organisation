...
add_action('plugins_loaded', function(){
 ...
 VTP_Public::instance();
 VTP_Dashboard::init();
 // Die Historie wird explizit innerhalb von VTP_Dashboard::render() ausgegeben.
 // Kein zweiter Dashboard-Hook, sonst erscheint der Block doppelt.

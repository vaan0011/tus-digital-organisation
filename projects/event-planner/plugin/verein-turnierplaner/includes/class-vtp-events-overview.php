...
class VTP_Events_Overview {
 ...
 private static function load_events(){
  ...
  // Die Event-Grunddaten bewusst separat und robust laden. Operative Zähler werden
  // danach ergänzt, damit ein Fehler in einer Nebenabfrage nie die gesamte Eventliste
  // verschwinden lässt.
  $sql=$wpdb->prepare(
   "SELECT * FROM $events

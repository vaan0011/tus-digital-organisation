...
Stand: 2026-09-10 – vollständiger Runtime-Abgleich bis einschließlich PR #68
...
| TuS Tauschbörse | Gesellschaft & Soziales; fachlicher Produkt-Owner nicht explizit benannt | Discovery | `reuse-marketplace/PROJECT-STATE.md` | konto-freien Vermittlungsablauf, Datenschutz/Missbrauchsschutz und realen `Kinder von Atibie`-Spendenweg konkretisieren; danach MVP festlegen | initialer Scope über PR #18 gemergt und Projektzustand über PR #68 reconciliiert; noch kein Plugin-Code | Entwicklung, Design, Datenschutz, Gesellschaft & Soziales, ggf. Funding |
| Team Manager | Sport; fachlicher Produkt-Owner nicht explizit benannt | Discovery | `team-manager/PROJECT-STATE.md` | gemeinsame Mannschaftsidentität und Saisonmodell definieren; danach Jahrgangs-/Ressourcenlogik und fussball.de-Anbindung untersuchen | initialer Scope über PR #17 gemergt und Projektzustand über PR #68 reconciliiert; keine parallele Mannschafts- oder Personendatenwelt aufbauen | Sport, Entwicklung, Datenschutz, Event Planner, Mitglieder & Engagement, Homepage |
| LED Media Screen | Sponsoring / Infrastruktur / Kommunikation; fachlicher Projekt-Owner noch offen | Discovery | `led-media-screen/PROJECT-STATE.md` | bis 30.09.2026 Technikbeiblatt, Fundament, Strom, Funding-Check, Genehmigung und Gesamtfinanzierung klären sowie erste Founding-Partner mit wenigen passenden Moment-Partner-Rollen ansprechen | Angebot 30260839-2: 48.779 € netto nach 2.000 € goracon-Sponsoringrabatt; Moment-Partner-Modell und Vorstandsvorlage dokumentiert; keine Bestellung ausgelöst | Partnership Manager, Funding & Grants, Infrastruktur, Finanzen, Kommunikation/Design, Vorstand |
...
| Großfeldtore Haupt- und Trainingsplatz | Sport / Infrastruktur; fachlicher Projekt-Owner noch offen | Geplant | `grossfeldtore-haupt-trainingsplatz/PROJECT-STATE.md` | finale Kübler-Konfiguration und Gesamtangebot gegen BSB-Sportgeräteförderung prüfen, fehlende Netze/Fracht sowie Fundament-/Einbauaufwand klären und danach Beschluss herbeiführen | qualifizierte Funding-Chance `OPP-001` mit Priorität A; bekannter Hardware-Zwischenstand 2.935,50 € brutto; vor Bestellung erneut verifizieren; keine Bestellung ausgelöst | Funding & Grants, Sport, Infrastruktur, Finanzen, Vorstand |
| Arbeitsplatz Sportparkteam | Sportpark / Infrastruktur / Vereinsentwicklung; fachlicher Projekt-Owner noch offen | Discovery | `arbeitsplatz-sportparkteam/PROJECT-STATE.md` | Arbeitgeber-Vorabklärung mit dem Jobcenter Bruchsal durchführen und persönliche Förderfähigkeit nach § 16i, hilfsweise § 16e, prüfen; parallel Tätigkeitsprofil und 20-/25-/30-Stunden-Modelle vorbereiten | qualifizierte Funding-Chance `OPP-004` mit Priorität B+; personenbezogene Daten außerhalb GitHub; Arbeitsvertrag erst nach positiver Förderentscheidung und TuS-Freigabe | Funding & Grants, Partnership Manager, Infrastruktur, Finanzen/Lohn, Datenschutz, Vorstand |
...
| TuS Tauschbörse | **aktuell** | PR #18 und der verbleibende Discovery-Einstieg sind über PR #68 im Projektzustand reconciliiert; nächste Aktualisierung erst bei realer Prozess-/MVP-Entscheidung |
| Team Manager | **aktuell** | PR #17 und der nächste Architektur-/Discovery-Schritt sind über PR #68 im Projektzustand reconciliiert; nächste Aktualisierung nach Entscheidung zu Mannschaftsidentität oder Saisonmodell |
...
4. **Qualifizierte Funding-Chancen abarbeiten:** `ACTIVE-OPPORTUNITIES.md` führt `OPP-001` Großfeldtore und `OPP-002` Umkleideböden als A-Chancen sowie `OPP-003` Historienarchiv und `OPP-004` Arbeitsplatz Sportparkteam als B+-Chancen. Vor Beauftragung, Vertrag oder Antrag die jeweiligen Gatekeeper erneut verifizieren.
